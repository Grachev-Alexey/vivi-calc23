...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      style={{
        background: "linear-gradient(160deg, hsl(222, 38%, 13%) 0%, hsl(220, 36%, 9%) 100%)",
        boxShadow: "0 24px 60px -16px rgba(0,0,0,0.7), 0 0 0 1px hsla(43, 88%, 56%, 0.18)",
        borderColor: "hsla(43, 88%, 56%, 0.25)",
      }}
      className={cn(
