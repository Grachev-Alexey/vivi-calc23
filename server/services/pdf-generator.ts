...
<body>
    ...
    <div class="title">
        Дополнительное соглашение об изменении условий к договору-оферте на оказание услуг по системе абонементов в студиях аппаратной косметологии «ЭНСО»
    </div>
    ` : `
    <div class="title">
        Приложение № 1 к договору-оферте на оказание услуг по системе абонементов в студиях аппаратной косметологии «ЭНСО»
    </div>
    `}
    ...
    <div class="section">
        ...
        <ul class="perks-list">
            <li>поддерживающие процедуры выбранных зон во всех студиях сети «ЭНСО»</li>
        </ul>
    </div>
    `
            : ""
